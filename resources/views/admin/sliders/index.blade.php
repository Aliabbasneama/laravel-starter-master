            ...
            <div class="card-header py-3 d-flex">
                ...
                <div class="ml-auto">
                    <a href="{{ route('admin.sliders.create') }}" class="btn btn-success">
                        ...
                        <span class="text">{{ __('New Slider') }}</span>
                    </a>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <table id="data-table" class="table table-bordered table-striped table-hover datatable datatable-role" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr data-entry-id="{{ $slider->id }}">
                                ...
                                <td>
                                    <img src="{{Storage::url($slider->banner)}}" width="200" alt="">
                                </td>
                                ...
                                <td>
                                    <div class="btn-group btn-group-sm">
                                        ...
                                        <form onclick="return confirm('are you sure ? ')" class="d-inline" action="{{ route('admin.sliders.destroy', $slider->id) }}" method="POST">
                                            @csrf
                                            @method('delete')
